      ...
      <div className="flex-grow px-4 md:px-10 lg:px-[170px] w-full mt-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex flex-col items-start">
            <h2 className="font-bold text-[28px] md:text-[32px]">UI/UX Designer</h2>
            <div className="flex flex-col md:flex-row items-start md:items-center font-bold gap-4 md:gap-8 mt-5 text-[#292D32]">
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 md:w-7 md:h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                </svg>
                <h2 className="text-[16px] md:text-[18px]">Bandung, Onsite</h2>
              </div>
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 md:w-7 md:h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  <path
                ...
                <h2 className="text-[16px] md:text-[18px]">Design</h2>
              </div>
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 md:w-7 md:h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  <path
                ...
                <h2 className="text-[16px] md:text-[18px]">Paid</h2>
              </div>
            </div>
          </div>
          ...
          <div className="self-start md:self-center">
            <button className="bg-[#C3423F] text-white text-sm md:text-[14px] font-semibold px-6 py-2 md:px-9 md:py-3 rounded-2xl shadow-xl" onClick={() => navigate("/RegisterIntern")}>
              Apply
            </button>
          </div>
        </div>
        ...
        <div className="mt-10 text-[#5F5F5F]">
          <div className="mb-6">
            <h2 className="text-[20px] font-semibold text-black mb-2">Deskripsi Pekerjaan :</h2>
          ...
          <div className="mb-6">
            <h2 className="text-[20px] font-semibold text-black mb-2">Kualifikasi :</h2>
          ...
          <div>
            <h2 className="text-[20px] font-semibold text-black mb-2">Benefit :</h2>
            <ul className="list-disc list-inside space-y-1">
